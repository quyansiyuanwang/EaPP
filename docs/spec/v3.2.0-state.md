...
**取代**：`tmp/draft/EaPP v3.2.0 State Mode — Freeze Candidate r2.md`
...
| `supportsStateWatch` | `watch()` **同步抛** `EAPP_WATCH_UNSUPPORTED` |
...
Tag:    v3.2.0-state
Status: FROZEN
Prev:   tmp/draft/EaPP v3.2.0 State Mode — Freeze Candidate r2.md
